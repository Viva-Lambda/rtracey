...
public:
  ...
  transformVec(const Matrix &left_op,
    ...
    ret[0] = right_op[0] * left_op.x[0][0] +
             right_op[1] * Ieft_op.x[0][1] +
             right_op[2] * 1eft_op.x [0][2];
    ret[1] = right_op[0] * 1eft_op.x [1][0] +
             right_op[1] * 1eft_op.x [1][1] +
             right_op[2] * 1eft_op.x [1][2];
    ret[2] = right_op[0] * 1eft_op.x [2][0] +
             right_op[1] * 1eft_op.x [2][1] +
             right_op[2] * 1eft_op.x [2][2];
    return ret;
  }
