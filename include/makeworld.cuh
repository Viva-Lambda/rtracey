...
SceneObjects make_cornell_box2() {
  ...
  GroupParam box2 =
      makeBox(Point3(0.0f), Point3(165.0f, 330.0f, 165.0f),
              white, 3);
  const TransParam transp = mkRotateY(-45.0f);
    //mkRotateTranslate(-18.0f, Vec3(0.0f, 1.0f, 0.0f),
  ...
  int msize = 0;
  //
  GroupParam *sgs = new GroupParam[msize + 2];
...
__global__ void make_cornell_box_k(SceneObjects world,
  ...
  GroupParam box2 =
      makeBox(Point3(0.0f), Point3(165.0f, 330.0f, 165.0f),
              white, 3);
  const TransParam transp = mkRotateY(18.0f);
  // mkRotateTranslate(-18.0f, Vec3(0.0f, 1.0f, 0.0f),
  //                  Point3(235.0f, 0.0f, 195.0f));
  box2.set_transparam(transp);
  // rotate_y(box2, 45.0f);
